...
echo "remap data from C48 to N45 regular lat-lon grid with conservative 1rst order"
echo "COMPILED ON `tail -n 1 $my_bin/COMPILE_HISTORY`"
echo "=============================================="

dir_in=/home/Mikyung.Lee/FRE-NCTools/TESTS_INPUT/Test05-input
dir_out=$PWD/Test05-conserve1-output
...
fregrid \
  ...
  --input_mosaic $dir_in/C48_mosaic.nc \
	...
	--output_dir ./ \
	--output_file 19800101.atmos_daily.all.nc \
	--check_conserve \
...
fregrid \
  --debug \
	...
	--interp_method conserve_order1 \
	--output_dir ./ \
	--output_file 19800101.atmos_daily.half.nc \
	--check_conserve \
	--remap_file C48_to_N45_remap.nc
