...
source run_tools.sh
echo "Testf second order conservative remapping from C3072 to lonlat 1140x720"

dir_in=/home/Mikyung.Lee/FRE-NCTools/TESTS_INPUT/Testf-input
dir_out=$PWD/tests_in_development/Testf-conserve2-output
...
output_mosaic=$(run_generate_lonlat 1140 720)
