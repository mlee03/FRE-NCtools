...
void setup_conserve_interp_acc(int ntiles_in, Grid_config *grid_in, int ntiles_out,
			   Grid_config *grid_out, Interp_config_acc *interp, unsigned int opcode);
void do_scalar_conserve_interp_acc(Interp_config_acc *interp, int varid, int ntiles_in, const Grid_config *grid_in,
			       int ntiles_out, const Grid_config *grid_out, const Field_config *field_in,
			       Field_config *field_out, unsigned int opcode, int nz);
void do_scalar_conserve_interp_order2_acc(Interp_config_acc *interp, int varid, int ntiles_in, const Grid_config *grid_in,
			       int ntiles_out, const Grid_config *grid_out, const Field_config *field_in,
			       Field_config *field_out, unsigned int opcode, int nz);
