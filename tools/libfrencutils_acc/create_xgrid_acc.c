...
#pragma omp target teams distribute reduction(+:upbound_nxcells) map(tofrom:upbound_nxcells)
...
#pragma omp parallel for reduction(+:upbound_nxcells) reduction(+:i_approx_xcells_per_ij1) \
